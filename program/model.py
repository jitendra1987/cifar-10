...
flags.DEFINE_integer('max_steps', os.getenv('TF_TRAIN_STEPS',1000), 'Number of steps to run trainer.')
flags.DEFINE_integer('hidden1', 120, 'Number of units in hidden layer 1.')
flags.DEFINE_integer('batch_size', os.getenv('TF_BATCH_SIZE', 10),
  'Batch size. Must divide dataset sizes without remainder.')
flags.DEFINE_string('train_dir', "{}/{}".format(DATUMS_PATH, DATASET_NAME),
